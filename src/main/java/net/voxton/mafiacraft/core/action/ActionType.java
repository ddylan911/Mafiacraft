...
import net.voxton.mafiacraft.core.action.action.CWorldActions;
import net.voxton.mafiacraft.core.action.action.ChatActions;
import net.voxton.mafiacraft.core.action.action.CityActions;
import net.voxton.mafiacraft.core.action.action.DistrictActions;
import net.voxton.mafiacraft.core.action.action.DivisionActions;
import net.voxton.mafiacraft.core.action.action.GovernmentActions;
import net.voxton.mafiacraft.core.action.action.MafiacraftActions;
import net.voxton.mafiacraft.core.action.action.SectionActions;
