...
import net.voxton.mafiacraft.action.actions.ChatCommand;
import net.voxton.mafiacraft.action.actions.CityCommand;
import net.voxton.mafiacraft.action.actions.DistrictCommand;
import net.voxton.mafiacraft.action.actions.DivisionCommand;
import net.voxton.mafiacraft.action.actions.GovernmentCommand;
import net.voxton.mafiacraft.action.actions.MafiacraftCommand;
import net.voxton.mafiacraft.action.actions.SectionCommand;
